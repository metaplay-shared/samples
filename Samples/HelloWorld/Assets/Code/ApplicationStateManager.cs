...
namespace Metaplay.Sample
{
    ...
    /// </summary>
    public class ApplicationStateManager : MonoBehaviour, IPlayerModelClientListener
    {
        /// <summary>
        ...
        async Task SessionLoop()
        {
            for (;;)
            {
                ...
                try
                {
                    ...
                    // Load any game resources and scenes here.
                    // We simulate the transition to in-game state by spawning the GameManager.
