...
namespace Server.Migrations
{
    ...
    [Migration("20250212113756_WebLoginFlowExpirationIndex")]
    partial class WebLoginFlowExpirationIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Metaplay.Server.PublicWebApi.PersistedWebLoginAuthorizationFlow", b =>
                {
                    ...
                    b.Property<byte[]>("ResolvedUserInfo")
                        .HasColumnType("longblob");
            ...
            modelBuilder.Entity("Metaplay.Server.Web3.PersistedNft", b =>
                {
                    b.Property<string>("GlobalId")
                        .HasMaxLength(256)
                        .HasColumnType("varchar(256)");
                    ...
                    b.Property<int>("MetaNftUserSchemaVersion")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("StringComparableTokenIdEquivalent")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("varchar(128)");
                    ...
                    b.Property<ulong>("UpdateCounter")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("StringComparableTokenIdEquivalent");

                    b.ToTable("Nfts", (string)null);
                });

            modelBuilder.Entity("Metaplay.Server.Web3.PersistedNftManager", b =>
                {
                    b.Property<string>("EntityId")
                        .HasMaxLength(64)
                        .HasColumnType("varchar(64)");
                    ...
                    b.ToTable("NftManagers", (string)null);
                });
