...
namespace Server.Migrations
{
    ...
    [Migration("20260922110351_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Game.Server.Match.PersistedMatch", b =>
                {
            ...
            modelBuilder.Entity("Game.Server.Tournament.PersistedTournamentDivision", b =>
                {
                    b.Property<string>("EntityId")
                        .HasMaxLength(64)
                        .HasColumnType("varchar(64)");
